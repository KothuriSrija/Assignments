...
//  */
 ...
 let StringArray = ['Phineas', 'Perry', 'Ferb']
...
function userFriends(username,...arg){
 ...
 userFriends("Candace","Buford","Isabella","Baljeet");
...
var nameList=["Phineas","Ferb","Perry","Candace","Jeremy"];
...
var names = ["PHINEAS", "FERB", "PERRY", "CANDACE"];
...
var SavingAccountObj = new SavingAccount(11,"Phineas",10000,10);
console.log(SavingAccountObj.getBalance());

var CurrentAccountObj = new CurrentAccount(11,"Ferb",60000,100);
