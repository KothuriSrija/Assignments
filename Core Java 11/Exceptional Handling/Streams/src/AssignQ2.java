...
public class AssignQ2 {
    ...
    public static void main(String[] args) {
        News news1 = new News(1, "Priya", "Varrier1", "comment");
        News news2 =new News(2, "Priya1", "Varrier", "budget");
        News news3 = new News(1, "Priya2", "Varrier2", "comment");
        News news4 = new News(3, "Priya3", "Varrier", "budget");
        News news5 = new News(1, "Priya4", "Varrier3", "comment");
        News news6 = new News(3, "Priya5", "Varrier", "budget");
        News news7 = new News(1, "Priya6", "Varrier5" ,"comment");
