...
public class AssignQ4 {
    ...
    public static void main(String[] args) {
    	Trader t1 = new Trader("Pink", "Hyderabad");
        Trader t2 = new Trader("Blue", "Paris");
        Trader t3 = new Trader("Green", "Mysore");
        Trader t4 = new Trader("Black", "Delhi");
        Trader t5= new Trader("Orange", "Indore");
        Trader t6 = new Trader("White", "Pune");
        Trader t7 = new Trader("Purple", "Delhi");
        Trader t8 = new Trader("Slate", "Himalayas");
        Trader t9 = new Trader("Light Pink", "Indore");

        Transaction ts1 = new Transaction(t1,2000,100);
        Transaction ts2 = new Transaction(t2,2001,150);
        Transaction ts3 = new Transaction(t3,2011,700);
        Transaction ts4 = new Transaction(t4,2010,300);
        Transaction ts5 = new Transaction(t5,2008,400);
        Transaction ts6 = new Transaction(t6,2011,800);
        Transaction ts7 = new Transaction(t7,2012,200);
        Transaction ts8 = new Transaction(t8,2015,450);
        Transaction ts9 = new Transaction(t9,2022,600);
