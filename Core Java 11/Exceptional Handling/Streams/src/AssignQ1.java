...
public class AssignQ1 {
    ...
    public static void main(String[] args) {
        ...
        fruits.add(new Fruit("StrawBerry",20,60,"Red"));
        fruits.add(new Fruit("Orange",30,60,"Orange"));
        fruits.add(new Fruit("Kiwi",30,100,"Brown"));
        fruits.add(new Fruit("Mango",60,110,"Yellow"));
        fruits.add(new Fruit("Grapes",40,60,"Black"));
        reverseSort( fruits);
        sort(fruits);
